  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <nav className="flex items-center gap-2 text-xs text-stone-500">
        ...
        <ChevronRight className="w-3.5 h-3.5 text-stone-400" />
        <Link
          to={`/halls?area=${encodeURIComponent(hall.area)}`}
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-stone-200/80">
        <div className="space-y-3">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {hall.isAC && <Badge variant="stone">100% Central AC</Badge>}
            {hall.hasParking && <Badge variant="stone">Valet Parking</Badge>}
          </div>

          <h1 className="font-serif font-extrabold text-3xl sm:text-4xl lg:text-5xl text-stone-950 tracking-tight">
            {hall.name}
          </h1>
          ...
          <div className="flex flex-wrap items-center gap-4 text-xs sm:text-sm text-stone-600">
            <div className="flex items-center gap-1.5 font-bold text-stone-900">
              ...
              <span className="text-stone-600 font-normal">({hall.reviewCount} Google reviews)</span>
            </div>
            <span>•</span>
        ...
        <div className="flex flex-wrap items-center gap-4 bg-white p-4 rounded-2xl border border-stone-200 shadow-sm">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-brand-900 hover:bg-brand-950 text-white font-bold text-xs sm:text-sm shadow-wedding transition-all hover:scale-102"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div id="enquiry-section" className="lg:col-span-1">
